...
namespace GUI
{
    public partial class frmBackupBandoDados : Form
    {
        public frmBackupBandoDados()
        {
            InitializeComponent();
        }

        private void btnBackupBandoDados_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnRestauraBancoDados_Click(object sender, EventArgs e)
        {
            try
            {
